...
![Transaction chain: tokenized gold → digital dollar → wallet → payment card — four separate jurisdictional layers connected by dotted lines](AML-IR-2026-010-header.png)
